...
function includeRegForm() {
    ...
    <div>
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-block" onclick="regSubmit()">Log in</button>
        </div>       
    </div>
...
function includeVendorRegForm() {
    ...
    <div>
        ...
        <div class="form-group">
            <input type="text" class="form-control" placeholder="Vendor Name (your company name)" required="required" id="vendor-name-input">
        </div>
        <div class="form-group">
            <input type="password" class="form-control" placeholder="Password" required="required" id="password-input">
        </div>
